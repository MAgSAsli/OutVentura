...
router.get("/", verifyToken, verifyRole(["admin", "pegawai", "owner", "staff"]), getAllTransaksi);
router.get("/laporan", verifyToken, verifyRole(["admin", "pegawai", "owner", "staff"]), getLaporanBulanan);
...
router.patch("/:id/status", verifyToken, verifyRole(["admin", "pegawai", "owner", "staff"]), updateStatus);
